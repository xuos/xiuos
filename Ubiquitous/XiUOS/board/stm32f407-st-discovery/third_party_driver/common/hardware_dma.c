/**
  ...
  * @brief      This file is based on stm32f4xx_dma.c
...
/**
* @file: hardware_dma.c
* @brief: support hardware dma function
* @version: 1.0
...
/*************************************************
File name: hardware_dma.c
Description: support hardware dma function
Others: 
History: 
1. Date: 2021-04-25
Author: AIIT XUOS Lab
Modification: 
1. rename stm32f4xx_dma.c for XiUOS
*************************************************/
