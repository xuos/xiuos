...
/**
* @file board.h
* @brief define aiit-riscv64-board init configure and start-up function
* @version 1.0 
...
/*************************************************
File name: board.h
Description: define aiit-riscv64-board board init function and struct
Others: https://canaan-creative.com/developer
History: 
1. Date: 2021-04-25
Author: AIIT XUOS Lab
Modification: 
1. define aiit-riscv64-board InitBoardHardware
2. define aiit-riscv64-board data and bss struct
*************************************************/
