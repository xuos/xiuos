...
/**
* @file: hardware_dbgmcu.h
* @brief: define hardware dbgmcu function
* @version: 1.0
...
/*************************************************
File name: hardware_dbgmcu.h
Description: define hardware dbgmcu function
Others: 
History: 
1. Date: 2021-04-25
Author: AIIT XUOS Lab
Modification: 
1. rename stm32f4xx_dbgmcu.h for XiUOS
*************************************************/

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __HARDWARE_DBGMCU_H__
#define __HARDWARE_DBGMCU_H__
