...
/**
* @file board.h
* @brief define aiit-arm32-board init configure and start-up function
* @version 1.0 
...
Author: AIIT XUOS Lab
Modification: 
1. define aiit-arm32-board InitBoardHardware
2. define aiit-arm32-board data and bss struct
*************************************************/
