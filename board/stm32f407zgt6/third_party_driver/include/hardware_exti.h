...
/**
* @file: hardware_exti.h
* @brief: define hardware exti function
* @version: 1.0
...
/*************************************************
File name: hardware_exti.h
Description: define hardware exti function
Others: 
History: 
1. Date: 2021-04-25
Author: AIIT XUOS Lab
Modification: 
1. rename stm32f4xx_exti.h for XiUOS
*************************************************/

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __HARDWARE_EXTI_H__
#define __HARDWARE_EXTI_H__
